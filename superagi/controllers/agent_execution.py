...
def create_agent_execution(
    ...
    agent_execution_knowledge = AgentConfiguration.get_agent_config_by_key_and_agent_id(
        session=db.session, key="knowledge", agent_id=agent_execution.agent_id
    )
    ...
    if agent_execution_knowledge and agent_execution_knowledge.value != "None":
        knowledge_name = Knowledges.get_knowledge_from_id(
            db.session, int(agent_execution_knowledge.value)
        ).name
    ...
    Models.api_key_from_configurations(
